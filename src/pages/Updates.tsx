          ...
          <div className="grid gap-8 max-w-4xl mx-auto">
            {updates.map((update, index) => (
              ...
              >
                ...
                >
                  <div className="rounded-2xl border border-border/50 overflow-hidden bg-card hover:border-foreground/30 transition-colors">
                    ...
                    <div className="p-6">
                      ...
                      <h2 className="font-display text-xl font-semibold mt-2 mb-2 group-hover:text-foreground/80 transition-colors">
                        {update.title}
                      </h2>
